...
/*-----------------------------Tests---------------------------------------------------------*/	
	...
	public void testCreateMilitaryCard(){
		...
		Assert.assertEquals(app.getUnit9Helper().getProtNumberLastCreatedCardU9(), mAVCard.protocolNumber);
	}
	...
	public void testEditMilitaryCard(){
		...
		Assert.assertEquals(app.getUnit9Helper().getValueInFieldLastCardU9(), mAVCard.someNewText);
	}
