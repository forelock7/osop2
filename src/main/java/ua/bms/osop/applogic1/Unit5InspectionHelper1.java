 ...
 */
public class Unit5InspectionHelper1 extends DriverBasedHelper implements Unit5InspectionHelper {
	
	/*Constructor of object which is managed by object Application Manager.*/
	public Unit5InspectionHelper1(ApplicationManager1 manager) {
